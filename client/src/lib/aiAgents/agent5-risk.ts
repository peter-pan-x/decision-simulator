...
export async function analyzeRisks(
  ...
  try {
    ...
    const systemPrompt =
      "You are a risk analysis expert. Respond with valid JSON only.";
    ...
    return {
      ...
      worstCaseScenario: parsed.worstCaseScenario || {
        description: "",
        probability: 0,
        triggers: [],
        consequences: [],
    ...
    return [
      {
        ...
        type: "career",
        description:
          "New company culture may not align with personal values and work style",
        probability: 0.35,
        impact: 7,
        severity: "high",
      ...
      },
      {
        ...
        type: "financial",
        description:
          "Higher cost of living in new location could offset salary increase",
        probability: 0.45,
        impact: 6,
        severity: "medium",
      ...
      },
      {
        ...
        type: "relationship",
        description:
          "Distance from family and friends may lead to isolation and loneliness",
        probability: 0.5,
        impact: 8,
        severity: "high",
      ...
      },
      {
        ...
        type: "career",
        description:
          "Promised growth opportunities may not materialize as expected",
        probability: 0.3,
        impact: 7,
        severity: "medium",
        timeframe: "1-2 years",
      },
      {
        ...
        type: "health",
        description:
          "Increased stress and pressure in new role could affect mental health",
        probability: 0.4,
        impact: 8,
        severity: "high",
  ...
  return [
    {
      ...
      description:
        "Overall economic climate and market conditions are unpredictable",
      impactRange: [-20, 30],
      controllability: 0.1,
    },
    {
...
function generateMitigationStrategy(risk: Risk): string {
  const strategies: Record<string, string> = {
    career:
      "Research company culture thoroughly before accepting. Request trial period or probation clause.",
    financial:
      "Create detailed budget for new location. Negotiate relocation package and cost-of-living adjustment.",
    relationship:
      "Establish regular communication schedule. Plan frequent visits. Build new social connections proactively.",
    health:
      "Set clear work-life boundaries from day one. Prioritize self-care and stress management practices.",
    other:
      "Build emergency fund covering 6-12 months expenses. Maintain professional network and skills.",
  };

  return (
    strategies[risk.type] ||
    "Develop contingency plan and monitor situation closely."
  );
}
...
function generateWorstCase(input: DecisionInput, risks: Risk[]): Scenario {
  ...
  return {
    description:
      "Multiple high-impact risks materialize simultaneously, creating a cascading failure scenario",
    probability: criticalRisks.reduce(
      (acc, r) => acc * (1 - r.probability),
      1 - 0.05
    ),
    triggers: [
